...
class DiscordClient(commands.Bot):
    ...
    async def status(self):
        ...
        match random_activity['activity']:
            ...
            case "listening":
                await self.change_presence(activity=discord.Activity(type=discord.ActivityType.listening, name=random_activity['name']))
            case "watching":
                await self.change_presence(activity=discord.Activity(type=discord.ActivityType.watching, name=random_activity['name']))
